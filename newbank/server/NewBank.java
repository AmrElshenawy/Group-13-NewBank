...
public class NewBank {
    ...
    //private LoanOffersHandler handleLoanOffers = new LoanOffersHandler();
    ...
    public HashMap<Integer, Customer> getAccountId2CustomerMapping() {
        return accountIdCustomer;
    }
    ...
    public HashMap<Customer, MicroLoan> getCustomer2MicroloansOffered() {
        return customerMicroloansOffered;
    }

    public HashMap<Customer, MicroLoan> getCustomer2MicroloansReceived() {
        return customerMicroloansReceived;
    }

    public HashMap<Account, MicroLoan> getAccount2MicroloansOffered() {
        return accountMicroloansOffered;
    }

    public HashMap<Account, MicroLoan> getAccount2MicroloansReceived() {
        return accountMicroloansReceived;
    }
